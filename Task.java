...
public class Task {
    public static void main(String[] args) {
        Array laptop1=new Array("Vivobook",1000,"ASUS");
        laptop1.setColor("metallic");
        laptop1.setHDD(512);
        laptop1.setOS("Windows 11");
        laptop1.setRAM(16);

        Array laptop2=new Array("MacBook Air 13", 2000,"Apple");
        laptop2.setColor("gray");
        laptop2.setHDD(256);
        laptop2.setOS("macOS Big Sur");
        laptop2.setRAM(8);

        Array laptop3=new Array("RedmiBook 14 II",3000,"Xiaomi");
        laptop3.setColor("gray");
        laptop3.setHDD(512);
        laptop3.setOS("Windows 11");
        laptop3.setRAM(16);

        Array laptop4=new Array("Spectre X360",4000,"HP");
        laptop4.setColor("black");
        laptop4.setHDD(512);
        laptop4.setOS("Windows 11");
        laptop4.setRAM(16);

        Array laptop5=new Array("ThinkPad X1",5000,"Lenovo");
        laptop5.setColor("black");
        laptop5.setHDD(512);
        laptop5.setOS("Windows 10 Pro");
        laptop5.setRAM(16);

        HashSet <Array> laptops = new HashSet<>(Arrays.asList(laptop1,laptop2,laptop3,laptop4,laptop5));
        HashSet <Array> result = new HashSet<>();
